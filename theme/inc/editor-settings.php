 ...
 */
function ace_allowed_block_types( $allowed_block_types, $editor_context ) {
...
add_filter( 'allowed_block_types_all', 'ace_allowed_block_types', 10, 2 );

/**
 * Remove Core Block Patterns to prevent clutter
 */
function ace_remove_core_block_patterns() {
	remove_theme_support( 'core-block-patterns' );
}
add_action( 'after_setup_theme', 'ace_remove_core_block_patterns' );
