...
while ( have_posts() ) :
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'school-single' ); ?>>
		...
		<header class="group entry-header relative">
					...
					<div class="relative z-20 w-full overflow-hidden py-20 lg:pb-32">
						...
						<div class="relative z-10 container">
							<div class="flex flex-col items-start">
								...
								<div class="mb-4 flex items-center gap-3">
									<div class="flex flex-wrap gap-2">
										...
										<?php if ( $ub_accreditation ) : ?>
											<span class="rounded-xs border border-white/20 bg-white/10 px-2 py-1.5 text-[0.625rem] leading-none font-bold text-white uppercase backdrop-blur-sm">
												<?php
								...
								<h1 class="translate-y-4 text-4xl leading-none font-bold text-white lg:text-6xl"><?php the_title(); ?></h1>
								<?php if ( $ub_en_name ) : ?>
									<p class="mt-8 max-w-4xl text-lg text-white/90"><?php echo esc_html( $ub_en_name ); ?></p>
								<?php endif; ?>
								
								<!-- Meta Info Row -->
								<div class="mt-8 flex flex-wrap items-center gap-x-6 gap-y-4 text-[0.625rem] font-bold tracking-widest text-white/60 uppercase">
									...
									<?php if ( $ub_ranking_korea ) : ?>
										...
										<div class="flex items-center gap-2">
											...
											<span class="mr-1 font-medium text-white/40 lowercase"><?php esc_html_e( 'Эрэмбэ:', 'aceedu' ); ?></span>
									...
									<?php if ( $ub_visa_rate ) : ?>
										...
										<div class="flex items-center gap-2">
											...
											<span class="mr-1 font-medium text-white/40 lowercase"><?php esc_html_e( 'Виза:', 'aceedu' ); ?></span>
								...
								<div class="mt-10 flex flex-wrap gap-3">
									<?php if ( get_field( 'official_website' ) ) : ?>
										<a href="<?php the_field( 'official_website' ); ?>" target="_blank" class="inline-flex items-center gap-2 rounded-xs border border-white/20 bg-white/10 px-6 py-2.5 text-[10px] font-black tracking-widest text-white uppercase no-underline backdrop-blur-sm transition-all hover:bg-white/20">
									...
									<?php if ( get_field( 'brochure_url' ) ) : ?>
										<a href="<?php the_field( 'brochure_url' ); ?>" target="_blank" class="inline-flex items-center gap-2 rounded-xs bg-white px-6 py-2.5 text-[10px] font-black tracking-widest text-primary uppercase no-underline transition-all hover:bg-slate-100">
											<svg class="h-4 w-4 text-primary italic" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
					...
					<section id="tuition" class="mb-20">
									...
									<table class="w-full border-collapse text-left">
										<thead>
											<tr class="border-b border-slate-100 bg-slate-50">
												<th class="w-2/3 px-6 py-4 text-xs font-black tracking-widest text-slate-900 uppercase"><?php esc_html_e( 'Тэнхим', 'aceedu' ); ?></th>
												<th class="px-6 py-4 text-xs font-black tracking-widest text-slate-900 uppercase"><?php esc_html_e( 'Төлбөр', 'aceedu' ); ?></th>
											</tr>
										</thead>
						...
						<?php if ( have_rows( 'scholarships_list' ) ) : ?>
							<div class="not-prose mt-16 border-t border-slate-100 pt-16">
								<h3 class="mb-12 text-center text-2xl font-black text-primary"><?php esc_html_e( 'Тэтгэлэгийн нөхцөлүүд', 'aceedu' ); ?></h3>
							...
							<div class="not-prose space-y-3">
								...
								while ( have_rows( 'faq_repeater' ) ) :
									...
									<div class="faq-item overflow-hidden rounded-xs border border-slate-100 shadow-xs">
										...
										<div class="faq-content hidden px-5 pb-5 text-slate-600">
			...
			<div class="container">
				<div class="mb-12 flex items-end justify-between gap-8">
					<div class="max-w-xl grow">
						<h2 class="mb-2 text-2xl leading-none font-bold tracking-tight lg:text-3xl"><?php esc_html_e( 'Төстэй сургуулиуд', 'aceedu' ); ?></h2>
						<p class="text-base leading-tight text-slate-500 opacity-80"><?php esc_html_e( 'Таны сонирхсон байршил дахь бусад сургуулиудыг эндээс хараарай.', 'aceedu' ); ?></p>
					</div>
		...
		?>
		<section id="inquiry" class="relative overflow-hidden bg-primary py-16 text-white lg:py-24">
			...
			<div class="relative z-10 container">
				<div class="mx-auto flex flex-col items-center text-center">
					<h2 class="mx-auto mb-3 text-2xl leading-tight font-bold text-white lg:text-3xl" style="max-width: <?php echo esc_attr( $ub_cta_title_rem ); ?>;">
