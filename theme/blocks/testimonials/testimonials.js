...
(() => {
    ...
    const initTestimonialsSlider = (block) => {
        ...
        new Swiper(sliderEl, {
            ...
            navigation: {
                nextEl: block.querySelector('[data-testimonials-carousel-next]'),
                prevEl: block.querySelector('[data-testimonials-carousel-prev]')
            },
            on: {
                init: function() {
                    setSameHeight(this);
     ...
     */
    const onReady = () => {
        document.querySelectorAll('.testimonials-block').forEach(initTestimonialsSlider);
    };
    ...
    if (window.acf) {
        window.acf.addAction('render_block_preview/type=testimonials', (block) => {
