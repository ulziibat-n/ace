	...
	<div class="container">
		<div class="flex flex-row gap-8 justify-between items-end mb-12">
			...
			<div data-carousel-nav class="flex gap-2 items-center pb-2 shrink">
				<button data-carousel-prev class="flex justify-center items-center w-12 h-12 bg-white rounded-full border border-white shadow-sm transition-all cursor-pointer group shadow-primary/5 hover:border-primary hover:bg-primary">
				...
				<button data-carousel-next class="flex justify-center items-center w-12 h-12 bg-white rounded-full border border-white shadow-sm transition-all cursor-pointer group shadow-primary/5 hover:border-primary hover:bg-primary">
