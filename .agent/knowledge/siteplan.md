Доорх судалгаанд тулгуурла: Doorkh-baiguullaguudyn-veb-sait-onlain-suvgiig-khoo-5.pdf (GKS, EduHelp, MBG, Сэц-Оюу + ACE-ийн Facebook нэгтгэсэн анализ).​
Урьдчилсан үндсэн цэс:
Нүүр хуудас
Бидний тухай
Сургуулиуд
Үйлчилгээ
Онлайн хичээл (Солонгос хэл 3 шат + LMS)
Харилцах
Чи хэрэгтэй гэж үзвэл шинээр хуудсууд (жишээ: Тэтгэлэг, Амжилтын түүх, Блог/Guide, FAQ гэх мэт) болон section-уудыг шинээр үүсгэж болно.​
...
1. Нүүр хуудас
2. Солонгост сурах (information hub)
    - Яагаад Солонгос вэ?
    - Замнал / Roadmap
        - Хэлний бэлтгэл
        - Бакалавр
...
3. Сургуулиуд
    ...
    - Хотын дагуух сургуулиуд (optional tag page)
4. Сургуулийн дэлгэрэнгүй
    - /schools/[slug]
5. Үйлчилгээ
    - GKS / Тэтгэлгийн бэлтгэл
    - TOPIK бэлтгэл
    - CV \& Essay \& Interview coaching
    - Виз \& Бүртгэл \& Онгоцны дараах дэмжлэг
    - “Full Journey” пакет (Хэлний бэлтгэл → Бакалавр/Master)
6. Онлайн хичээл
    - Overview (Онлайн академи + LMS)
    - Level 1 – Суурь шат
    - Level 2 – Дунд шат
    - Level 3 – Ахисан шат
7. Тэтгэлэг
    - GKS overview (guidance, албан бус тайлбар)
    - Их сургуулийн тэтгэлгүүд
    - ACE-ийн хөнгөлөлт, дотоод тэтгэлэг
8. Амжилтын түүх
    - GKS тэтгэлэгт тэнцсэн түүхүүд
    - Хэлний бэлтгэл → Бакалавр кейсүүд
    - Эцэг эхийн testimonial
    - Case detail page (/stories/[slug])
9. Блог / Guide
    - Category:
        - GKS \& тэтгэлэг
        - TOPIK \& хэлний стратеги
        - Major choice / Career
        - Life in Korea
        - Visa \& Accommodation
10. FAQ
    ...
    - Санхүү \& Төлбөр
11. Event / Webinar
    - Ирэх вебинар / live / expo
    - Өнгөрсөн event recap + видео
12. Бидний тухай
    - Brand story
    - Mission, Vision, Values
    - Our approach
...
13. Онлайн бүртгэл
    ...
    - “Материал илгээх” (upload)
14. Харилцах
    - Contact info + map
    - Lead form (богино)
    - Social links
15. Legal / Utility (footer only)
    - Privacy policy
    - Terms \& conditions
...
- Нүүр: FB-ээс орж ирсэн бүх урсгалын default landing, awareness + consideration + immediate lead capture.[^1_1]
- Солонгост сурах: Top-of-funnel education hub, trust + education build, blog-той холбогдох gateway.[^1_1]
- Сургуулиуд: Consideration үеийн “option exploration”, ACE curated network-ийг харуулж trust өсгөнө.[^1_1]
- Сургуулийн дэлгэрэнгүй: High-intent хэрэглэгчийг conversion-д ойртуулдаг product detail page (school as product).[^1_1]
- Үйлчилгээ: ACE-г зөвхөн мэдээлэл өгөгч биш, structured packaged solution provider гэдгийг тодруулна (mid → bottom funnel).[^1_1]
- Онлайн хичээл: Recurring revenue + independent funnel (TOPIK, хэлний сургалт) – lead-үүдийг “сурах замнал” руу дахин cross-sell хийнэ.[^1_1]
- Тэтгэлэг: High-intent traffic (GKS гэх мэт keyword) → consult funnel рүү оруулах, lead magnet.[^1_1]
- Амжилтын түүх: Social proof hub – ACE-ийг Сэц Оюу шиг системтэй testimonial-тэй болгох, брэндийн trust differentiation.[^1_1]
- Блог/Guide: SEO + FB контентын landing; educational positioning + lead nurturing.[^1_1]
- FAQ: Friction бууруулах, support load багасгах, conversion-д тусална.[^1_1]
- Event/Webinar: FB live/Expo-гийн төв landing, registration funnel.[^1_1]
- Бидний тухай: Premium имидж, team credibility, long-term trust-building.[^1_1]
...
- Navigation (left/center):
    ...
    - Блог / Guide
- Right-side CTAs:
    - Primary button: **БҮРТГҮҮЛЭХ** (links to Онлайн бүртгэл)
    - Secondary text link: Үнэгүй зөвлөгөө (scroll to hero form эсвэл /contact)
...
- Column 1 – Brand
    - Logo + short tagline: “Солонгост хэлний бэлтгэлээс тэтгэлэг хүртэл, нэг газраас.”
    - About ACE (link to Бидний тухай)
- Column 2 – Програм, үйлчилгээ
    - Солонгост сурах
    - Сургуулиуд
    - Үйлчилгээ
    - Онлайн хичээл
    - Тэтгэлэг
- Column 3 – Нөөц, контент
    - Амжилтын түүх
    - Блог / Guide
    - FAQ
    - Event / Webinar
- Column 4 – Холбоо
    ...
    - Privacy policy
    - Terms \& conditions
- Social + quick CTA (footer доод хэсэг):
    - FB, IG, YouTube icon-ууд
...
- Зорилго: Awareness + Conversion – ACE-ийн position-ийг 3 секундын дотор ойлгуулах, “Үнэгүй зөвлөгөө авах” lead form руу чиглүүлэх.[^1_1]
...
- Гол мессеж bullet-ууд:
    ...
    - FB community, live зөвлөгөө, бодит кейс дээр суурилсан guidance
    - Premium зөвлөх баг – Солонгост сурч/амьдарч байсан туршлагатай

UX:

- Desktop:
    - Left: Headline + subheadline + bullet list
    - Right: Short lead form (4–5 талбар)
        - Нэр
        - Утас
        - Facebook/IG линк
        - Одоогийн түвшин (11-р анги, оюутан, төгсөгч, ажилтан – dropdown)
        - Зорих шат (Хэлний бэлтгэл / Бакалавр / Магистр / GKS)
    - Buttons:
        - Primary: **Үнэгүй зөвлөгөө авах**
        - Secondary (text link): Хөтөлбөрүүдийг үзэх
- Mobile:
    - Stack: Headline → subheadline → primary CTA button → “folded” form (button дарахад bottom sheet form нээгдэх)

Visual direction:

- Background: soft Korea cityscape + campus + real Mongolian students (ACE photo shoot)
- Photo style: natural light, candid moments, Korean campus vibe, 2–3 хүнтэй group shot.
- Color: Navy / royal blue primary, warm accent (orange/amber) CTA.

CTA copy жишээ:

- Primary:
    - “Үнэгүй зөвлөгөө авах”
    - “Өөрийн боломжоо үнэгүй шалгуулах”
- Secondary:
    - “Хөтөлбөрүүдийг үзэх”
...
- Зорилго: Consideration – замналыг visual-лаж, хүний толгой дахь “messy dream”-ийг structured roadmap болгох.[^1_1]

Контент:

- Гарчиг:
    - “Солонгост сурах 3 үндсэн замнал”
    - “Хэлний бэлтгэлээс тэтгэлэг хүртэл – алхам алхмаар”
- Дэд гарчиг:
    - “Таны одоогийн түвшинд таарах замыг ACE-ийн зөвлөх танд хамт сонгоно.”
- Картууд:
    - Карт 1: Хэлний бэлтгэл
        - “TOPIK 3–4 түвшинд хүрэх зорилгоор 1–2 жилийн бэлтгэл.”
    - Карт 2: Бакалавр
        - “Солонгосын их сургуульд мэргэжлээ сонгож, 4 жилийн хөтөлбөрт элсэх.”
    - Карт 3: Магистр / GKS
        - “Тэтгэлэгт хөтөлбөрүүдээр дамжуулан магистр, судалгааны шатанд үргэлжлүүлэх.”

UX:

- Desktop: 3–4 card horizontal, each with icon/step number.
- Mobile: horizontal scroll cards (step 1–3), доор “Өөрийн шатанд тохирсон зөвлөгөө авах” CTA.

Visual:

- Icons: step icons (1, 2, 3), line connector.
- Photo: small inline photos (graduation cap, classroom, city).
...
- Зорилго: Trust + differentiation – Сэц Оюу, MBG, EduHelp-ээс хэрхэн өөрийг гаргах.[^1_1]

Контент:

- Гарчиг:
    - “Яагаад ACE-ээр дамжуулж Солонгост сурах ёстой вэ?”
- Дэд гарчиг:
    - “Солонгос only, хэлний өөрийн төв, идэвхтэй FB community ба тэтгэлэгт чиглэсэн structured бэлтгэл.”
- Bullet / icon grid (3–4 item):
    - Солонгос only, бүх шатны нэг цэгийн үйлчилгээ
    - GKS, их сургуулийн тэтгэлэгт чиглэсэн тусгай хөтөлбөр
    - FB live, reels-ээр батлагдсан community, олон кейс
    - High-touch зөвлөгөө – 1:1 roadmap, материалын нарийн шүүлт

UX:

- 2x2 icon grid, each card clickable → “Бидний тухай” эсвэл “Үйлчилгээ” рүү link.

Visual:

- Simple line icons (focus, scholarship, community, consulting).
- Optionally small stat text (“X+ intake, Y+ оюутан”).
...
- Зорилго: Service awareness + click-through to services page (consideration → conversion).[^1_1]

Контент:

- Гарчиг:
    - “ACE-ийн packaged services”
- Card-ууд:
    - GKS \& тэтгэлгийн бэлтгэл
    - TOPIK бэлтгэл \& хэлний сургалт
    - CV, Essay, Interview coaching
    - Виз, бүртгэл, онгоцны дараах дэмжлэг

Card бүр дээр:

- 1–2 өгүүлбэр тайлбар:
    - “GKS болон их сургуулийн тэтгэлэгт шаардлагатай эссе, судалгааны proposal, CV, ярилцлагын бэлтгэлийг нэг цогцоор нь хийж өгнө.”
    - “TOPIK оноогоо зорилтот түвшинд хүргэх онлайн+танхимын холимог хөтөлбөр.”

UX:

- Desktop: 3–4 card grid, hover state.
- Mobile: vertical stacked card.

Visual:

- Minimal icons per service (scholarship cap, document, plane etc.).
...
- Зорилго: Trust – Сэц Оюу шиг системтэй social proof block-ийг ACE-д шилжүүлэх.[^1_1]

Контент:

- Stats:
    - “X+ суралцсан оюутан”
    - “Y+ Солонгосын их дээд сургууль”
    - “Z жилийн туршлага”
- Testimonial slider:
    - 2–3 GKS / major кейсээс богино quote (name, program, year).
- Partner logos:
    - 8–20 сургуулийн logo grid (even if partial at first, structure бэлэн).

UX:

- Desktop: 3-column stats → testimonial slider → logo grid.
- Mobile: stacked; logo grid 2-column.

Visual:

- Real student photos next to quote.
- Logo-ууд clean monochrome/brand color.
...
- Зорилго: Drive to blog/guide (top/mid funnel education).[^1_1]

Контент:

- Гарчиг:
    - “Солонгост сурахад бэлдэх гол guide-ууд”
- 3–4 article card:
    - “11-р ангиас GKS-д бэлдэх 3 жилийн roadmap”
    - “TOPIK 0 → 3 түвшинд 1 жилийн төлөвлөгөө”
    - “Солонгост амьдрах зардал: Сөүл vs бусад хот”
- Card copy: 1–2 өгүүлбэр teaser.

UX:

- Horizontal cards with category chip (GKS, TOPIK, Life in Korea).
...
- Зорилго: FB funnel integration + community engagement.[^1_1]
...
- Гарчиг:
    - “Ирэх live \& event-үүд”
- 1 main upcoming:
    - Title, date/time, description, “FB Live / Zoom” badge.
- 1–2 past event recap card.

UX:

- Small event list + “Бүх event-үүдийг харах” линк (/events).

Visual:

- Event cover thumbnail (FB cover зургийг reuse хийж болно).
...
- Зорилго: Objection handling, friction reduction before final CTA.[^1_1]

Контент:

- 4–6 асуулт:
    - “GKS тэтгэлэгт тэнцэхэд ямар гол шалгууртай вэ?”
    - “Солонгост сурахад жилд дунджаар хэдий хэмжээний зардал гарах вэ?”
    - “Солонгос хэл байхгүй байхад эхлэх боломжтой юу?”
    - “Зөвлөгөө үнэгүй юу?”
...
- Зорилго: Main conversion (lead capture).[^1_1]

Контент:

- Гарчиг:
    - “Өөрийн Солонгосын замналын талаар ярилцъя.”
- Sub:
    - “Доорх мэдээллээ үлдээвэл ACE-ийн зөвлөх 24 цагийн дотор холбогдоно.”
...
- Fields:
    ...
    - Утас
    - Facebook/IG линк
    - Одоогийн боловсролын түвшин (dropdown)
    - Зорих жил (2027, 2028, 2029…)
    - Сонирхож буй шат (checkbox)
- Privacy text:
...
- Desktop: 2-column (left explanation, right form).
...
- Нэр
- Хот
- Төрөл (National/Private, Research, Women’s University etc.)
- Чиглэл (Humanities, Engineering, Arts… tags)
- Scholarship overview (e.g. “Partial scholarship up to 50%”)
...
- Default filters:
    - Хот (dropdown / multi-select chip)
    - Түвшин (Хэлний бэлтгэл / Бакалавр / Магистр)
    - Чиглэл (tag chips)
- Desktop:
    - Top filter bar, left side filter, right side grid.
- Mobile:
...
- 2–3 өгүүлбэр:
    - Сургуулийн түүх, хэмжээ (тоо бичихгүй skeleton), академик онцлог.

Programs \& levels:

- Structure:
    - Program name
    - Level (Language / Bachelor / Master)
    - Duration (1 жил, 4 жил гэх мэт)
    - Language (Korean / English / Mixed)
    - Main outcomes (e.g. TOPIK 4+, portfolio etc.)

Scholarship:

- Text style:
    - “ACE-ийн оюутнуудын хувьд дундаж scholarship нь partial/tuition discount хэлбэрээр, шаардлага нь TOPIK X түвшин, GPA X.X+ байх нь түгээмэл.”
    - Тодорхой хувь бичихгүй, guidance хэлбэр.

ACE support:

- 4–6 bullet:
    - “Хөтөлбөр, major match зөвлөгөө”
    - “Material review (CV, эссе, recommendation)”
    - “Application timeline management”
    - “Visa \& accommodation guidance”
    - “Сургуульд хүлээж авах бичиг баримтын coordination”
...
- Headline: “Солонгост сурах зорилгоо structured үйлчилгээний цогц шийдлээр дэмжье.”
- Sub: “GKS, TOPIK, CV \& эссе, виз, онгоцны дараах дэмжлэгийг тус тусад нь эсвэл нэг пакет байдлаар авах боломжтой.”
...
- Hero headline:
    - “GKS тэтгэлэгт системтэй бэлдэх one-stop package.”
- Sub:
    - “GPA, хэлний түвшин, CV, эссе, research proposal-оо GKS шалгуурт нийцүүлэхэд чиглэсэн 3–6 сарын бэлтгэл.”

Who is this for:

- Bullet:
    - “GPA X.X+ түвшинтэй бакалавр/оюутан, англи/солонгосоо дундаас дээш түвшинд хүргэсэн залуус.”
...
- Outcome – 3–5 bullet (what student can do after).
- Syllabus summary – modules list.
- Format – number of lessons, live sessions, Q\&A.
- Support – quizzes, feedback, community group.
- CTA – “Энэ түвшинд бүртгүүлэх”.
...
[^1_1]: Doorkh-baiguullaguudyn-veb-sait-onlain-suvgiig-khoo-5.pdf

[^1_2]: EduHelp.mn-Nariivchilsan-Veb-Sait-Onlain-Suvgii-3.pdf

[^1_3]: MBG-Education-Center-Nariivchilsan-Veb-Sait-Anali-4.pdf
